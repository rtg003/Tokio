...
// Formulário de login (client). A seção de carteira (SIWE) só aparece quando o
// servidor a habilita (allowlist não-vazia) — `siweEnabled` vem do server
// component `login/page.tsx`. Sem SIWE, a tela é só senha, limpa.
export function LoginForm({ siweEnabled }: { siweEnabled: boolean }) {
    ...
    <div className="loginwrap">
      ...
      <form className="logincard" onSubmit={handleLogin}>
        ...
        <div className="hint">
          ...
          {siweEnabled ? "; login por carteira restrito à allowlist" : ""}
        </div>
      </form>
    </div>
  );
