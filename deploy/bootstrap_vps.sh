...
REQUIRED_VARS=(HL_ACCOUNT_ADDRESS HL_AGENT_PRIVATE_KEY GATEWAY_CONTROL_TOKEN
               DASHBOARD_PASSWORD DASHBOARD_AUTH_SECRET)
...
# DASHBOARD_* é usado pelo Next; exportar o .env antes do build
